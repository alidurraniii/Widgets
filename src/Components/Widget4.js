...
import '../css/Widget4.css'


const input= <i className="icon1 fa-brands fa-square-snapchat"></i>;
...
function Widget4() {
  ...
  return (
    <div className ="container">
        <h2>Snapchat Icons</h2>
        <div className ="row">
            <div className ="widget1 col-md-2 p-2 border">
                <i className="icon1 fa-brands fa-square-snapchat"></i>
