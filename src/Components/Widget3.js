...
import '../css/Widget3.css'


const input= <i className="icon1 fa-brands fa-square-instagram"></i>;
...
function Widget3() {
  ...
  return (
    <div className ="container">
        <h2>Instagram Icons</h2>
        <div className ="row">
            <div className ="widget1 col-md-2 p-2 border">
                <i className="icon1 fa-brands fa-square-instagram"></i>
